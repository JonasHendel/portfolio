		...
		<div className={styles.innerCard}>
			...
			>
				...
				<p className='text-lg font-medium text-slate-700 leading-8'>
					...
					be unthinkable. I also like doing things where I end up with a useful product. I
					worked a lot with wood when I was young, built things with construction kits and
					later also made texture packs for computer games. When a good friend though me a
					little about coding, I soon knew: This is what I want to do. On the one hand,
					this field is extremely diverse and can be combined with other natural sciences.
					In addition, you end up with a, in most cases, useful program. Since I started
					with coding/computer science the reasons why I do it has never changed. It just
					feels so good to code, when you finally fix that bug, to learn a lot and to have
					a nice product in the end.
				</p>
			</motion.div>
			<motion.div
